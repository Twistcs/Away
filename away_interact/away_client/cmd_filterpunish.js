            ...
            if(module.exports.ClientModules['util_permission.js'].hasPermissionFromMsg(msg, 'ADMINISTRATOR')) {
                if(parsedContent.args.length == 0) {
                    msg.reply(
                        ...
                        .addField('**Punishment Thresholds:**',
                            'Ban: ' + guildInformation.data.flagsBeforeBan + ' flags\n' +
                            'Tempban: ' + guildInformation.data.flagsBeforeTempban + ' flags\n' +
                            'Kick: ' + guildInformation.data.flagsBeforeKick + ' flags\n' +
                            'Mute: ' + guildInformation.data.flagsBeforeMute + ' flags'
                        )
                    );
